                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="(knn, index) in knns.data" :key="index">
                                    ...
                                    <td>
                                        <div v-if="knn.berat == 1" style="color:red">Berat Obesitas</div>
                                        <div v-if="knn.berat == 2" style="color:#39FF14">Berat Normal</div>
                                        <div v-if="knn.berat == 3" style="color:yellow">Berat Kurus</div>
                                        <div v-if="knn.berat == 4" style="color:red">Berat S.Kurus</div>
...
export default {
    setup() {
        ...
        onMounted(() => {
            //ambil data dari api
            axios.get('http://127.0.0.1:8000/api/berskur')
                .then((result) => {
